...
{
    public abstract class PurchDepControllerBase<TSource, TResult> : ControllerBase where TSource : class where TResult : class
    {
        public Service<TSource, TResult> Service { get; }
        protected PurchDepControllerBase(Service<TSource, TResult> service)
        {
            Service = service;
        }
